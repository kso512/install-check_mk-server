...
| -------- | ----------- | ----- |
| install_check_mk_server_build | Build number included in RPM source filename | `66` |
...
| install_check_mk_server_version | Version of Check_MK RAW to install | `1.4.0p19` |
